    ...
    <div className="min-h-screen bg-[#F9F7F4] dark:bg-[#1A1A1A] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#58595b] dark:text-[#E8E4DE]">{sv ? 'Glömt lösenord?' : 'Forgot password?'}</h1>
        </div>
        <div className="bg-white dark:bg-[#2A2A2A] rounded-2xl shadow-sm border border-gray-100 dark:border-[#3D3D3D] p-8">
          {sent ? (
            <div className="text-center">
              <div className="text-4xl mb-4"></div>
              <h2 className="text-xl font-semibold text-[#58595b] dark:text-[#E8E4DE] mb-3">{sv ? 'E-post skickad!' : 'Email sent!'}</h2>
              <p className="text-gray-500 dark:text-[#A0A0A0] mb-6">
                {sv
